...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      In my spare time, I enjoy playing bass guitar, video gaming, and blogging.
       I'm always enthusiastic about new projects across different fields, so feel free to reach out for potential collaborations.
    </Text>
  </Fragment>
);
